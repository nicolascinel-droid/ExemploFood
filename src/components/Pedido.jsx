...
// Array de objetos contendo estado inicial do cardápio
const cardapio=[
    ...
    // usa a função updater para garantir o valor mais recente do estado
        ...
        //o original(IMUTABILIDADE)
            prev.map(item =>
                ...
                // atualizado apenas a quantidade mantendo o resto
                //Math.max : garante que a quantidade nunca seja menor que 
